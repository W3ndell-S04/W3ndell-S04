# Olá, eu sou o Wendell Lago! 👋

### 👨‍💻 Analista de Infraestrutura | Redes | Segurança | Automação

Atualmente atuo na sustentação de ambientes críticos na **Justiça Federal**, com foco em administração de redes Cisco, servidores Windows/Linux e segurança de perímetros. Sou apaixonado por resolver problemas através de automação e scripts.

---

### 🚀 Tecnologias e Ferramentas
- **Infraestrutura:** Cisco, FortiGate, Active Directory, VMware.
- **Linguagens:** Python, PowerShell, C, SQL.
...
- **Portfólio:** [https://portfolio-sable-ten-44.vercel.app/](https://portfolio-sable-ten-44.vercel.app/)
